...
information, TCP stability, roaming behavior, and Bonjour / mDNS service
discovery.
...
-   Updated product screenshots and website presentation
...
### Key Features
  ...
  Bonjour / mDNS service discovery    Discover local services advertised
                                      through standard Bonjour / mDNS
                                      protocols.

  WiFi roaming report                 Record SSID and BSSID samples while
                                      moving between WiFi coverage areas.

  Privacy-first design                No account required and no
                                      diagnostic cloud upload.
  -----------------------------------------------------------------------

### Bonjour / mDNS Service Discovery

WiFi Health Check v1.4 adds Bonjour / mDNS based local service
discovery.

This improves local network visibility by helping identify available
services such as:
...
This feature is designed for service visibility and discovery. It is not
a vulnerability scanner and does not discover passwords or credentials.
...
该功能用于服务可见性分析，不是漏洞扫描工具，不会获取账号密码。
...
-   LAN Scan with Bonjour / mDNS screenshot
-   App icons
-   Website branding assets
-   Social sharing images

Unused legacy screenshots have been removed.
...
-   Reports remain on the device
-   Data leaves the device only when explicitly shared by the user
